--admin
--pass: admin123
insert into USERS(address, blocked, email, first_name, last_name, password, phone_number, picture, role, deleted)
values ('Bulevar oslobodjenja 12 Novi Sad', false, 'admin@gmail.com', 'Admin', 'Admin','$2a$10$SNwqKTpejKgVD9kMunSvYuVPgF/rs9oq5TEkWMwRUb75hb2CVMUa6', '0664587545', 'picture', 'ADMIN', false);
insert into ADMINS(id) values (1);

--guests
--pass: marko123
insert into USERS(address, blocked, email, first_name, last_name, password, phone_number, picture, role, deleted)
values ( 'Bulevar oslobodjenja 127, Novi Sad', false, 'marko.markovic@gmail.com', 'Marko', 'Markovic', '$2a$10$pW7xhKHkW/n6UAr1zlrK8OG9lZgio/Ix/K3dltB512sCDRL8h9ZI2', '06652685', 'picture', 'GUEST', false);
...
--pass: petar123
insert into USERS(address, blocked, email, first_name, last_name, password, phone_number, picture, role, deleted)
values ( 'Bulevar oslobodjenja 2, Novi Sad', false, 'petar.petrovic@gmail.com', 'Petar', 'Petrovic', '$2a$10$cQnYiXJL0XHGoX27SCRLjOhoHRzKWlzkNP5sEXjStrFdtjAntCHH6', '066874521', 'picture', 'GUEST', false);
insert into GUEST(id) values (3);

--hosts
--pass: andrea123
insert into USERS(address, blocked, email, first_name, last_name, password, phone_number, picture, role, deleted)
values ( 'Bulevar oslobodjenja 78, Novi Sad', false, 'andrea.katzenberger@gmail.com', 'Andrea', 'Katzenberger', '$2a$10$PelwlV29qdhWztr21ChMBeYYQUkWMuJhJhYqLKBKQiTa7he8qaIN6', '0641254658', 'picture', 'HOST', false);
insert into HOST(id) values (4);

--pass: mirko123
insert into USERS(address, blocked, email, first_name, last_name, password, phone_number, picture, role, deleted)
values ( 'Bulevar oslobodjenja 7, Novi Sad', false, 'mirko.mirkovic@gmail.com', 'Mirko', 'Mirkovic', '$2a$10$bm0/QkZmhQEQVI8LwFV9QeescIjZjdJSHre/xK2lJw020xCHJxV0m', '0645879458', 'picture', 'HOST', false);
