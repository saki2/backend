...
public class RequestGuestDTO {
    ...
    public ResponseGuestDTO parseToResponse(Long id){
        ResponseGuestDTO passengerResponse = new ResponseGuestDTO(this.name, this.surname, this.profilePicture, this.telephoneNumber, this.email, this.address);
        passengerResponse.setId(id);
        return passengerResponse;
    }

    public Guest parseToGuest(){
        return new Guest(this.name, this.surname, this.profilePicture, this.telephoneNumber, this.email, this.address, this.password);
    }
}
